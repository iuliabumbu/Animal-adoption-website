	...
	<div class="row">
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  ...
						  <a href="ClientControl?page=pesti" class="list-group-item" style="background: #ffd7b3;">Pesti</a>
						</div> 
 				</div><!-- left -->

 				<div class="col-md-8"><!-- right -->
 					<h3 style="text-align: center;">Pesti</h3><br>
