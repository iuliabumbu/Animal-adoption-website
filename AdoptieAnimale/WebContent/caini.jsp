	...
	<div class="row">
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  ...
						  <a href="ClientControl?page=caini" class="list-group-item" style="background: #ffd7b3;">Caini</a>
 				...
 				<div class="col-md-8"><!-- right -->
 					<h3 style="text-align: center;">Caini</h3><br>
