	...
	<h2>Lista Veterinari:</h2>
		 ...
		 <c:forEach items="${result.rows }" var="row">
		  <table style="table-layout: fixed;width: 100%;">
				...
				<tr>
				    <td style="width: 130px;"><c:out value="${row.idveterinar }"></c:out></td>
					<td style="width: 130px;"><c:out value="${row.nume }"></c:out></td>
					<td style="width: 130px;"><c:out value="${row.prenume}"></c:out></td>
					<td style="width: 130px;"><c:out value="${row.adresa }"></c:out></td>
					<td style="width: 130px;"><c:out value="${row.email }"></c:out></td>
					<td style="width: 130px;"><c:out value="${row.telefon}"/></td>
