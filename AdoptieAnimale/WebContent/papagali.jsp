	...
	<div class="row">
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  ...
						  <a href="ClientControl?page=papagali" class="list-group-item" style="background: #ffd7b3;">Papagali</a>
 				...
 				<div class="col-md-8"><!-- right -->
 					<h3 style="text-align: center;">Papagali</h3><br>
					...
					<c:if test="${animal.isAdoptat() == 'false' }">
						<c:if test="${animal.getTip() == 'papagal' }">
