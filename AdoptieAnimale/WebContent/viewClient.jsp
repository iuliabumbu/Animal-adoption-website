		 ...
		 <c:forEach items="${result.rows }" var="row">
		  <table style="table-layout: fixed;width: 100%;">
				...
				<tr>
					...
					<td style="width: 100px;"><a href="editClient.jsp?nume=${row.nume }&prenume=${row.prenume}&id=${row.userid}&parola=${row.parola}
					&adresa=${row.adresa}&email=${row.email}&telefon=${row.telefon}" style="color: #6bb1f8;">edit</a> ||
					<a href="deleteClient.jsp?id=${row.userid}" style="color:#6bb1f8;">delete</a></td>
