...
<body>
	...
	<div class="signup-header">
	 ...
	 <input type="hidden" name="page" value="add_veterinar">
     
	 	<div class="signup-group">
	 		<label>Nume</label>
	 		<input type="text" name="nume" placeholder="Vet last name"  required>
	 	</div>
	 		<div class="signup-group">
	 		<label>Prenume</label>
	 		<input type="text" name="prenume" placeholder="Vet first name"  required>
	 	</div>
