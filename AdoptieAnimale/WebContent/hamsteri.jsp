	...
	<div class="row">
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  ...
						  <a href="ClientControl?page=hamsteri" class="list-group-item" style="background: #ffd7b3;">Hamsteri</a>
 				...
 				<div class="col-md-8"><!-- right -->
 					<h3 style="text-align: center;">Hamsteri</h3><br>
					...
					<c:if test="${animal.isAdoptat() == 'false' }">
						<c:if test="${animal.getTip() == 'hamster' }">
